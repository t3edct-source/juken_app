...
2. **不適切な選択肢の特定**
   ...
   - **誤答選択肢が正しい内容を含んでいないか確認**
     - 解説に記載されている正しい内容が誤答選択肢に含まれていないか確認
     - 問題文の文脈で正しいと判断できる内容が誤答選択肢に含まれていないか確認
     - 例: 「再生可能エネルギーの特徴」という問題で、誤答選択肢に「再生可能エネルギー」という正しい内容が含まれている場合は不適切
     - 例: 「外来種のひ害」という問題で、誤答選択肢に「生態系を変えてしまう」という正しい内容が含まれている場合は不適切

3. **選択肢の修正**
   - 同一カテゴリの選択肢に統一
   - 適切な誤答選択肢に変更
     - **誤答選択肢は明確に間違っている内容にする**
     - 正しい内容を含む選択肢は誤答選択肢として不適切なため、明確に間違っている内容に変更
   - 選択肢の順序を適切に並べ替え
...
- [ ] 選択肢数が統一されている（通常は4択）
- [ ] 選択肢が同一カテゴリに統一されている
- [ ] 誤答選択肢が正しい内容を含んでいない（明確に間違っている内容になっている）
- [ ] 問題番号が1から連番になっている
...
4. **誤答選択肢の確認**: 誤答選択肢が正しい内容を含んでいないか確認し、明確に間違っている内容に修正
5. **思考型問題の追加**: 単純な知識問題から思考を要する問題へ変更
6. **段階的な修正**: 一度にすべてを修正せず、段階的に進める
7. **記録の徹底**: 修正内容を記録し、後で確認できるようにする
