window.questions = [
  ...
  },
  {
    ...
    "choices": [
      "植物の数が最も多く、草食動物、肉食動物へとたどるにつれて、数は少なくなる",
      "植物の数が最も少ない",
      "すべての生物の数が同じ",
      "草食動物の数が最も多い"
    ],
  ...
  },
  {
    ...
    "choices": [
      "一時的に変化するが、もとにもどることが多い",
      "ずっと変化し続ける",
      "変わらない",
      "改善する"
    ],
    "answer": 0,
    "source": "つり合いがくずれたとき、一時的に生物の数は変化するが、もとにもどることが多いです。例えば、草食動物が増えると、植物が減り、草食動物の食べ物が減るため、草食動物も減ります。このようにして、生物の数のつり合いが保たれることが多いです。ただし、絶滅などで完全に戻らない場合もあります。",
    "tags": ["つり合い", "生物の数", "変化"],
    "difficulty": 1,
    "asof": "2026-01-02"
  },
  ...
  },
  {
    ...
    "choices": [
      "イネ→イナゴ→カエル→フクロウ、キャベツ→モンシロチョウの幼虫→モズ→タカ",
      "イネ→イナゴ→カエル→フクロウ",
