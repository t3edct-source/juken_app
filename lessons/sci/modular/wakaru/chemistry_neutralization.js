...
window.questions = [
  ...
  },
  {
    ...
    "choices": [
      ...
      "水酸化ナトリウムだけが残る"],
    "answer": 1,
    "source": "水よう液の水を蒸発させたとき、水酸化ナトリウム水よう液を加えてちょうど中和するまでは、中和によってできた食塩が残ります。中和が完了するまでは、中和によってできた食塩だけが水に溶けているため、水を蒸発させると食塩だけが残ります。<img src=\"../images/chemistry/neutralization/neutralization17.png\" alt=\"図解\" style=\"max-width: 100%; margin: 1rem 0; border-radius: 8px; display: block;\">",
    "tags": ["中和", "蒸発", "食塩", "基本"],
    "difficulty": 2,
    "asof": "2026-01-03"
  },
  {
    ...
    "choices": [
      ...
      "何も残らない"],
    "answer": 1,
    "source": "水よう液の水を蒸発させたとき、水酸化ナトリウム水よう液を加えてちょうど中和したあとは、食塩と加えた水酸化ナトリウムが残ります。中和が完了した後は、余った水酸化ナトリウムも水に溶けているため、水を蒸発させると、食塩と水酸化ナトリウムの両方が残ります。<img src=\"../images/chemistry/neutralization/neutralization18.png\" alt=\"図解\" style=\"max-width: 100%; margin: 1rem 0; border-radius: 8px; display: block;\">",
  ...
  },
  {
    ...
    "choices": [
      ...
      "水よう液の体積が増えたから"],
    "answer": 0,
    "source": "マグネシウムを加えたとき、水素の発生量がしだいに小さくなるのは、中和によって塩酸の性質が弱くなったからです。中和が進むと、塩酸の量が減り、酸性が弱くなるため、マグネシウムとの反応が弱くなり、水素の発生量が減ります。<img src=\"../images/chemistry/neutralization/neutralization19.png\" alt=\"図解\" style=\"max-width: 100%; margin: 1rem 0; border-radius: 8px; display: block;\">",
