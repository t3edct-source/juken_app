window.questions = [
  ...
  },
  {
    ...
    "answer": 0,
    "source": "太陽が東にある朝の時間帯では、光は東から差し込みます。そのため、影は太陽とは反対側の「西」に向かってできるのが基本です。影が太陽と反対方向になるのは、光が直進し、物の裏側に光が届かない部分が影として残るためです。朝の影が西にのびるのは、その日の太陽の位置を理解する手がかりになります。<img src=\"../images/earth/sun_movement_shadow/sun_movement_shadow8.png\" alt=\"図解\" style=\"max-width: 100%; margin: 1rem 0; border-radius: 8px; display: block;\">",
    "tags": [],
    "difficulty": 1,
    "asof": "2025-01-27"
  },
  ...
  },
  {
    ...
    "answer": 0,
    "source": "南中した太陽は南の空にあります。そのため、光は南から当たり、影はその反対側の「北」にできます。南中時の影の向きはいつも北を指すため、影を使って方角を知るときの重要な基準となります。昔の人々は、この性質を利用して方角を判断していました。",
    "tags": [],
    "difficulty": 1,
    "asof": "2025-01-27"
  },
