...
window.questions = [
  ...
  },
  {
    ...
    "変わらない"],
    "answer": 1,
    "source": "豆電球を直列につなぐと、電池から流れる電流が減るので、電池のもちは長いです。直列つなぎでは、電球が増えると回路全体の抵抗が大きくなるため、同じ電圧でも流れる電流が小さくなります。電流が小さいと、電池から取り出すエネルギーの量も少なくなるため、電池が長持ちします。<div style=\"font-family: 'Courier New', monospace; white-space: pre-wrap; line-height: 1.6; margin-top: 1rem; padding: 1rem; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #4facfe;\">【直列つなぎと電池から流れる電流】\n\n【1個のとき】\n    [+] 電池\n    │\n    ↓ 電流：大きい\n   (●) 電球\n    │\n    [-] 電池\n\n【2個直列のとき】\n    [+] 電池\n    │\n    ↓ 電流：小さい（減る）\n   (●) 電球1\n    │\n    ↓ 電流：小さい\n   (●) 電球2\n    │\n    [-] 電池\n\n結果：\n  • 電球が増える → 抵抗が大きくなる\n  • 同じ電圧でも電流が小さくなる\n  • 電池から取り出すエネルギーが少ない\n  • 電池が長持ちする</div>",
  ...
  },
  {
    ...
    "変わらない"],
    "answer": 2,
    "source": "豆電球を2個、3個と並列につないでも、豆電球1個に流れる電流の大きさは変わらないので、豆電球の明るさは1個のときと同じです。並列つなぎでは、各電球が電源に直接つながっているため、各電球にかかる電圧は同じです。そのため、各電球に流れる電流も同じ大きさになり、明るさも変わりません。<div style=\"font-family: 'Courier New', monospace; white-space: pre-wrap; line-height: 1.6; margin-top: 1rem; padding: 1rem; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #4facfe;\">【並列つなぎと各電球に流れる電流】\n\n【1個のとき】\n    [+] 電池\n    │\n    ↓ 電流：I\n   (●) 電球（明るい）\n    │\n    [-] 電池\n\n【2個並列のとき】\n    [+] 電池\n    │\n    ├─→ 電流：I（同じ）\n    │    (●) 電球1（明るい）\n    │\n    └─→ 電流：I（同じ）\n         (●) 電球2（明るい）\n    │\n    [-] 電池\n\n結果：\n  • 各電球が電源に直接つながる\n  • 各電球にかかる電圧は同じ\n  • 各電球に流れる電流も同じ\n  • 明るさは1個のときと同じ</div>",
    "tags": ["豆電球", "並列", "電流", "基本"],
    "difficulty": 2,
    "asof": "2026-01-03"
  },
